...
const ShippingForm = () => {
  ...
  const handleCheckout = async () => {
    ...
    const {
      ...
      `https://ecommerse-server-j8hm.onrender.com/checkout/order/${localStorage.getItem(
        "userId"
      )}`,
      {
        amount,
    ...
    const options = {
      ...
      order_id: order.id,
      callback_url: `https://ecommerse-server-j8hm.onrender.com/checkout/order/${localStorage.getItem(
        "userId"
      )}/paymentverification`,
      prefill: {
